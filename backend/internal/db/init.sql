...
INSERT INTO dorms (id, name_of_dorm, address) VALUES
(1, 'Общежитие 1', 'Улица 1, СПб')
...
('averich.pa@edu.spbstu.ru', 'hahich321', '5132701/20002', '4353546354', 1, '2001-02-02', 'Аверич Полина Александровна', 'Санкт-Петербургский политехнический универститет Петра Великого', 'Институт энергетики', 0, TRUE, '+79528128128', 314),
('kringalov.sv@edu.spbstu.ru', 'ktonacpal2003', '5132701/20003', '635657336', 1, '2002-03-03', 'Кринжалов Сергей Владимирович', 'Санкт-Петербургский политехнический универститет Петра Великого', 'Институт компьютерных наук и кибербезопасности', 1, FALSE, '+79528153128', 322),
('ivanov.aa@edu.spbstu.ru', 'pass123', '5132701/20004', '7456231987', 1, '2000-05-15', 'Иванов Александр Андреевич', 'Санкт-Петербургский политехнический университет Петра Великого', 'Институт информационных технологий', 0, TRUE, '+79520123456', 315),
('petrova.ms@edu.spbstu.ru', 'mypassword', '5132701/20005', '9834521670', 1, '2001-08-22', 'Петрова Мария Сергеевна', 'Санкт-Петербургский политехнический университет Петра Великого', 'Институт энергетики', 1, FALSE, '+79521234567', 316),
('sidorov.ev@edu.spbstu.ru', 'evgen123', '5132701/20006', '5623487190', 1, '2002-11-30', 'Сидоров Евгений Викторович', 'Санкт-Петербургский политехнический университет Петра Великого', 'Институт компьютерных наук и кибербезопасности', 2, TRUE, '+79522345678', 323);
